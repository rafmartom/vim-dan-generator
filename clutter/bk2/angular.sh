...
arranging_rules(){
    ...
    find ${DOCU_PATH}/downloaded -mindepth 1 -maxdepth 1 -type d \
        -not \( -name "api" -o -name "best-practices" -o -name "cli" -o -name "ecosystem" -o -name "errors" -o -name "essentials" -o -name "guide" -o -name "reference" -o -name "tools" -o -name "tutorials" \) \
        -exec rm -r {} \;
...
parsing_rules(){
    ...
    write_html_docu_multirule_bk -f "h1" -b "div .adev-header-and-tabs" -b ".docs-viewer" -cp -lp -c "105"
