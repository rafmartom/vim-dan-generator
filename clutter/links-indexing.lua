...
--   into a .csv file  we call "links-index.csv"
--     It will be writting them into a .csv
--         - {DOCU_PATH}/links-index.csv
...
-- @todo label is not really needed
local label = nil
local anchor_id = nil
local buid = nil
local iid = nil
...
--- Appends the entry of the current file as a block_link to the "links-index.csv"
function append_block_link(doc)
    ...
    output_str = string.format("%s,%s,%s,%s,%s,%s,%s,false\n", file_processed, is_anchor, pandoc_data_type, label, anchor_id, buid, iid)
...
--- Appends an entry for an inline_link to the "links-index.csv"
