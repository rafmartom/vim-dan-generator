...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "section h1" -b "li.current, .rst-content"
...
EOF
    ...
    write_html_docu_multirule -f "section h1" -b "li.current, .rst-content" -cd "javascript" -il -c "105" -cc "${cleanup_command}"
