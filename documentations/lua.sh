...
arranging_rules(){
    ...
    mv ${DOCU_PATH}/downloaded/www.lua.org/manual/5.4/* ${DOCU_PATH}/downloaded/
    rm -r ${DOCU_PATH}/downloaded/www.lua.org


    ## Removing non-interest files

    rm ${DOCU_PATH}/downloaded/contents.html
...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "nothing" -b "body"
