...
arranging_rules(){
    ...
    find ${DOCU_PATH}/downloaded -mindepth 1 -maxdepth 1 \
        -not \( -name "blog" -o -name "docs" -o -name "faq" \) \
        -exec rm -r {} \;
...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "head title" -b "div.guide-content" -b "body"
...
EOF
    ...
    write_html_docu_multirule -f "head title" -b "div.guide-content" -b "body" -cd "sh" -il -c "105" -cc "${cleanup_command}"
