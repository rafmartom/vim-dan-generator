...
arranging_rules(){
    ...
    mkdir -p ${DOCU_PATH}/downloaded/en-US/docs/Web/HTML/
    cp -r ${DOCU_PATH}/../mdn-parent/downloaded/developer.mozilla.org/en-US/docs/Web/HTML/* ${DOCU_PATH}/downloaded/en-US/docs/Web/HTML/
