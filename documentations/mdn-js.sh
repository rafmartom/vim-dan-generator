...
arranging_rules(){
    ...
    mkdir -p ${DOCU_PATH}/downloaded/en-US/docs/Web/JavaScript/
    cp -r ${DOCU_PATH}/../mdn-parent/downloaded/developer.mozilla.org/en-US/docs/Web/JavaScript/* ${DOCU_PATH}/downloaded/en-US/docs/Web/JavaScript/
