...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "h1.title" -f "h1" -f "h2" -b "body" -b "main"
...
EOF
    ...
    write_html_docu_multirule -f "h1.title" -f "h1" -f "h2" -b "body" -b "main" -cd "sh" -il -c "105" -cc "${cleanup_command}"
