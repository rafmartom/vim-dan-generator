...
arranging_rules(){
    ...
    mkdir -p ${DOCU_PATH}/downloaded/en-US/docs/Web/SVG/
    cp -r ${DOCU_PATH}/../mdn-parent/downloaded/developer.mozilla.org/en-US/docs/Web/SVG/* ${DOCU_PATH}/downloaded/en-US/docs/Web/SVG/
