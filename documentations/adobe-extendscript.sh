...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "section h1" -b "div.document"
...
EOF
    ...
    write_html_docu_multirule -f "section h1" -b "div.document" -cd "javascript" -il -c "105" -cc "${cleanup_command}"
