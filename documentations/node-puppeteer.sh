...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "article div.theme-doc-markdown h1" -b "article div.theme-doc-markdown"
...
EOF
    ...
    write_html_docu_multirule -f "article div.theme-doc-markdown h1" -b "article div.theme-doc-markdown" -cd "javascript" -il -c "105" -cc "${cleanup_command}"
