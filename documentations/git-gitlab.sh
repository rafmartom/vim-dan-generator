#!/bin/bash 
# @file git-gitlab
# @brief vim-dan ruleset file for documentation on git-gitlab
# @description
...
filtering_rules() {
    ...
    for DOWNLOAD_LINK in "${DOWNLOAD_LINKS[@]}"; do
        ...
        sed -ni '\|^\"https://docs[.]gitlab[.]com.*|p' ${LOCAL_CSV_PATH}
...
EOF
    ...
    write_html_docu_multirule -f "h1" -b "main" -cd "sh" -il -c "105" -cc "${cleanup_command}"
