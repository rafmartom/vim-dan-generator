...
arranging_rules(){
    ...
    rm -r ${DOCU_PATH}/downloaded/next
...
parsing_rules(){
    ...
    #
    write_html_docu_multirule -f "article div.theme-doc-markdown h1" -b "article div.theme-doc-markdown" -cp -lp -c "105"
...
#        -e '/^$/{:a;N;s/\n$//;ta}' \
    ...
    sed -i '24a\'$'\n''&@ g:dan_kw_tabline_list = "^Signature:,^Returns:,^Parameters,^Example,^Remarks" @&' "${MAIN_TOUPDATE}"
