...
arranging_rules(){
    ...
    find ${DOCU_PATH}/../google-devs-parent/downloaded/developers.google.com/ -mindepth 1 -maxdepth 1 -type d \
        -not \( -name "ad-manager" -o -name "google-ads" -o -name "android" -o -name "search" -o -name "maps" -o -name "display-video" -o -name "apps-script" -o -name "gmail" -o -name "drive" \) \
...
parsing_rules(){
    ...
    write_html_docu_multirule -f "h1" -b "div.devsite-article-body" -b "article" -lp -c "200"
