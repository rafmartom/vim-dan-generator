...
arranging_rules(){
    ...
    find ${DOCU_PATH}/downloaded -mindepth 1 -maxdepth 1 -not -name "referece" rm {} \;
    mv ${DOCU_PATH}/downloaded/reference/en/* ${DOCU_PATH}/downloaded/
    rm -r ${DOCU_PATH}/downloaded/reference
...
parsing_rules(){
    ...
    #
    write_html_docu_multirule -f "h1" -b "div#bodyContent" -cp -fm "tail -n +6" -lp -c "105"
