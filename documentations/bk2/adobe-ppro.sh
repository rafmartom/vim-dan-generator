...
arranging_rules(){
    ...
    rm -r ${DOCU_PATH}/downloaded/print_page
...
#    write_html_docu_multirule -f "h1" -b "article" -cp
#    write_html_docu_multirule -f "section h1" -b "div.document" -cp
    write_html_docu_multirule -f "h1" -b "nav .md-nav--secondary, article" -cp -lp -c "105"
