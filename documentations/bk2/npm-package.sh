...
spidering_rules(){
    ...
    ## We are using the repository https://github.com/nice-registry/download-counts 
    ##    to get the name of the 50,000 most downloaded packages in npm
    ##
    ##  $ mkdir temporary-repo
    ##  $ cd temporary-repo
    ##  $ yarn add download-counts
    ##  $ cp vim-dan-generator/helpers/get-npm-package-csv.js temporary-repo/
    ##  $ node ./get-npm-package-csv.js
    ##  $ cp https___www.npmjs.com.csv /vim-dan-generator/index-links/
    
      # Compressing the file
      bzip2 "$CURRENT_DIR/../index-links/https___www.npmjs.com.csv"
...
indexing_rules(){
    ...
    for DOWNLOAD_LINK in "${DOWNLOAD_LINKS[@]}"; do
        download_fromlist_waitretry ${DOWNLOAD_LINK} 2 150
    done
...
parsing_rules(){
    ...
    #
    write_html_docu_multirule -f "h1" -b "section, div.w-third-l" -cp -lp -c "105"
