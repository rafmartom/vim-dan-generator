...
arranging_rules(){
    ...
    find ${DOCU_PATH}/downloaded -mindepth 1 -maxdepth 1 -type d -not -name "www.gov.uk" -exec rm -r {} \;
...
parsing_rules(){
    ...
    #
    write_html_docu_multirule -f ".govuk-heading-xl" -f ".govuk-heading-l" -b "#guide-contents" -b "main" -lp -c "105" 
