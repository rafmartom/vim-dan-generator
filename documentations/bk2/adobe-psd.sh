...
arranging_rules(){
    ...
    ## Unnesting documentation
    mv ${DOCU_PATH}/downloaded/photoshop-docs/* ${DOCU_PATH}/downloaded/
    rm -r ${DOCU_PATH}/downloaded/photoshop-docs
...
parsing_rules(){
    ...
    #
    write_html_docu_multirule -f "h1" -b "article" -b ".document" -cp -lp -c "105"
