...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "h1" -b "body"
...
writting_rules(){
    ...
    #    write_html_docu_multirule -f "h1" -b "article" -cd "man"
    #
    #  Other Example:
    ...
    #
    #    write_html_docu_multirule -f "head title" -b "div.guide-content" -b "body" -cd "man"
    #
...
#   write_html_docu_multirule -f "h1" -b "body" -fm "$file_mangling" -cd "man" -il -c "105"
    write_html_docu_multirule -f "h1" -b "body" -cd "man" -il -c "105"
