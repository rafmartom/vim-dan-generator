...
spidering_rules(){
    ...
    ## No need for standard spider as website is a wiki with so many updates and clutter
    ## There is a release of the Archive 
    ##   the link can be found in the bottom of the page "offline archive"
    ##   https://en.cppreference.com/
    ##
    ##    Unofficial Release   html-book-yearMonthDay.zip
    ##    Copy that link

    echo "Using a packaged index"
    echo "Current link used is ${PACKAGE_LINK} , if you want to change it refer to the source file for instuctions to change it on the comments"
    PACKAGE_LINK="https://github.com/PeterFeicht/cppreference-doc/releases/download/v20250209/html-book-20250209.zip"

    wget "${PACKAGE_LINK}" -P ${DOCU_PATH}/downloaded
...
indexing_rules(){
    echo "Unzipping a packaged index"

    unzip ${DOCU_PATH}/downloaded/html-book-20250209.zip
    rm ${DOCU_PATH}/downloaded/html-book-20250209.zip
}
...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "h1" -b "div#bodyContent"
...
EOF
    ...
    #    write_html_docu_multirule -f "h1" -b "article" -cd "cpp"
    #
    #  Other Example:
    ...
    #
    #    write_html_docu_multirule -f "head title" -b "div.guide-content" -b "body" -cd "cpp"
    #
    
    write_html_docu_multirule -f "h1" -b "div#bodyContent" -cd "cpp" -il -cc "${cleanup_command}"

#    write_html_docu_multirule -f "h1" -b "div#bodyContent" -cd "cpp" -il -c "105"
