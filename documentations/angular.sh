...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "h1" -b "div .adev-header-and-tabs"
...
EOF
    ...
    write_html_docu_multirule -f "h1" -b "div .adev-header-and-tabs" -cd "typescript" -il -c "105" -cc "${cleanup_command}"
