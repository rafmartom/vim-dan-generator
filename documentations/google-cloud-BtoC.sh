...
arranging_rules(){
    ...
    cp -r ${DOCU_PATH}/../google-cloud-parent/downloaded/cloud.google.com/[b-cB-C]* ${DOCU_PATH}/downloaded/
...
parsing_rules(){
    ...
    write_html_docu_multirule -f "h1" -b "div.devsite-article-body" -b "article" -cp -il -c "200"
