#!/bin/bash 
# @file govuk-publications
# @brief vim-dan ruleset file for documentation on govuk-publications
# @description
...
arranging_rules(){
    ...
    cp -r ${DOCU_PATH}/../govuk-parent/downloaded/www.gov.uk/government/publications ${DOCU_PATH}/downloaded/goverment/
