...
arranging_rules(){
    ...
    rm -r ${DOCU_PATH}/downloaded/cdn-cgi
    rm ${DOCU_PATH}/downloaded/index.html
    rm -r ${DOCU_PATH}/downloaded/en/latest

    rm -r ${DOCU_PATH}/downloaded/en/stable/_static
    rm -r ${DOCU_PATH}/downloaded/en/stable/presentations
...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "article h1" -b "article"
...
EOF
    ...
    #    write_html_docu_multirule -f "h1" -b "article" -cd "help"
    #
    #  Other Example:
    ...
    #
    #    write_html_docu_multirule -f "head title" -b "div.guide-content" -b "body" -cd "help"
    #
    

    write_html_docu_multirule -f "article h1" -b "article" -cd "python" -il -c "105" -cc "${cleanup_command}"
