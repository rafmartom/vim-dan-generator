...
arranging_rules(){
    ...
    # Selecting only important documents to be visualized
#    mv ${DOCU_PATH}/downloaded/expressjs.com/en/5x/api.html ${DOCU_PATH}/downloaded/
#    mv ${DOCU_PATH}/downloaded/expressjs.com/en/advanced ${DOCU_PATH}/downloaded/
#    mv ${DOCU_PATH}/downloaded/expressjs.com/en/guide ${DOCU_PATH}/downloaded/
#    mv ${DOCU_PATH}/downloaded/expressjs.com/en/resources ${DOCU_PATH}/downloaded/
#    mv ${DOCU_PATH}/downloaded/expressjs.com/en/starter ${DOCU_PATH}/downloaded/
#
#    rm -r ${DOCU_PATH}/downloaded/expressjs.com
...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "h1" -b "#api-doc" -b "#page-doc"
...
EOF
    ...
    write_html_docu_multirule -f "h1" -b "#api-doc" -b "#page-doc" -cd "javascript" -il -c "105" -cc "${cleanup_command}"
