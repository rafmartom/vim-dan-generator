...
arranging_rules(){
    ...
    # developer.mozilla.org/en-US/docs/*  except Web
    find ${DOCU_PATH}/../mdn-parent/downloaded/developer.mozilla.org/en-US/docs/ -mindepth 1 -maxdepth 1 -not -name "Web" -exec cp -r {} ${DOCU_PATH}/downloaded/ \;

    # developer.mozilla.org/en-US/docs/Web/* , that hasnt been done on mdn-webapi mdn-js etc...
    mkdir -p ${DOCU_PATH}/downloaded/Web 
    find ${DOCU_PATH}/../mdn-parent/downloaded/developer.mozilla.org/en-US/docs/Web/ -mindepth 1 -maxdepth 1 \
        -not \( -name "API" -o -name "CSS" -o -name "JavaScript" -o -name "HTTP" -o -name "SVG" -o -name "HTML" \) \
        -exec cp -r {} ${DOCU_PATH}/downloaded/Web/ \;
