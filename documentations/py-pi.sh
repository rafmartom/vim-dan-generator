...
#    fi
    ...
    echo "No need to perform any arrangement on this documentation"
}


parsing_rules(){

    parse_html_docu_multirule -f "h1.package-header__name" -b "div.project-description"
...
EOF
    ...
    write_html_docu_multirule -f "h1.package-header__name" -b "div.project-description" -cd "python" -il -c "105" -cc "${cleanup_command}"
