...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "h1" -b "#DisplayArea"
...
EOF
    ...
    write_html_docu_multirule  -f "h1" -b "#DisplayArea" -cd "python" -il -c "105" -cc "${cleanup_command}"
