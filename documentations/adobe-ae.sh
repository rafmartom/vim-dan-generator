...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "h1" -b "nav .md-nav--secondary, article"
...
EOF
    ...
    write_html_docu_multirule -f "h1" -b "nav .md-nav--secondary, article" -cd "javascript" -il -c "105" -cc "${cleanup_command}"
