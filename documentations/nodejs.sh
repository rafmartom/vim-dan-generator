#!/bin/bash 
# @file nodejs
# @brief vim-dan ruleset file for documentation on nodejs
# @description
...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "#apicontent h2" -f "main h1" -b ".toc, div[role=maine]" -b "main"
...
#        -i "${MAIN_TOUPDATE}"
    ...
    write_html_docu_multirule -f "#apicontent h2" -f "main h1" -b ".toc, div[role=maine]" -b "main" -cd "javascript" -il -c "105"
