...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "main article h1" -b "main article"
...
EOF
    ...
    #    write_html_docu_multirule -f "h1" -b "article" -cd "javascriptreact"
    #
    #  Other Example:
    ...
    #
    #    write_html_docu_multirule -f "head title" -b "div.guide-content" -b "body" -cd "javascriptreact"
    #
    

    write_html_docu_multirule -f "main article h1" -b "main article" -cd "javascriptreact" -il -c "105" -cc "${cleanup_command}"
