...
parsing_rules(){
    ...
    parse_html_docu_multirule -f "h1" -b "div.theme-doc-markdown"
...
writting_rules(){
    ...
    ## Change below patterns of text to be cleaned for each document
    ##
...
EOF
    ...
    write_html_docu_multirule -f "h1" -b "div.theme-doc-markdown" -cd "javascript" -il -c "105" -cc "${cleanup_command}"
