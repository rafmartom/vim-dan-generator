...
##    
##
##    find ${DOCU_PATH}/downloaded/ -mindepth 1 -maxdepth 1 -not \( -name "labels" -o  -name "modules" -o -name "about.html" -o -name "index.html" -o -name "modules.html" \) -exec rm -r {} \;
##
##    find ${DOCU_PATH}/downloaded/modules -mindepth 1 -maxdepth 1 -type f -exec rm -r {} \;
##
##    find ${DOCU_PATH}/downloaded/modules -mindepth 2 -maxdepth 2 -type d -exec rm -r {} \;
##
